...
class CallPage extends StatefulWidget {
  ...
  //final String ip;
  //CallPage({Key key, @required this.ip}) : super(key: key);

  static String ip = 'wrtc.jegerima.dev';
          ...
          ? SizedBox(
              ...
              child: Row(
                  ...
                  children: <Widget>[
                    ...
                    FloatingActionButton(
                      child: Icon(_isMuted?Icons.mic:Icons.mic_off),
                      onPressed: _isMuted?_unmuteMic:_muteMic,
                    )
                  ]))
          : null,
      body: _inCalling
